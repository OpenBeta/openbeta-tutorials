...
if __name__ == '__main__':
    ...
    model = gensim.models.doc2vec.Doc2Vec(vector_size=50, min_count=2, epochs=80, window=10) # upped the epochs from typical 10-20 since the descriptions are relatively short
